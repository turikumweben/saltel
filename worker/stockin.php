...
$insert="INSERT INTO stockin (pid,quantity,quality,date) VALUES('$pid','$quantity','$quality','$date')";
 $result=mysqli_query($conn,$insert);
 if($result){
    echo'<script>alert("🎈stokin alread adde👌👌");</script>';
 }
 else{
    echo'<script>alert("stokin failed to add");</script>';
 }
}
?>
